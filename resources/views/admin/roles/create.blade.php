...
<div class="card">
    <div class="card-body">
        ...
        <h4 class="header-title font-24">Create role</h4>

        <form action="{{ route('roles.store') }}" method="post" role="form" class="parsley-examples" >
            @csrf
            <div class="row mb-3">
                <label for="inputEmail3" class="col-4 col-form-label">Name<span class="text-danger">*</span></label>
                <div class="col-7">
                    <input name="name" value="{{ old('name') }}" type="text" parsley-type="name" class="form-control" id="inputEmail3" placeholder="Name" />
                    @error('name')
            ...
            <div class="row mb-3">
                ...
                <div class="col-7">
                    <input name="display_name" value="{{ old('display_name') }}" id="hori-pass1" type="text" placeholder="Display name" class="form-control" />
                    @error('display_name')
                        <span class="text-danger"> {{ $message }}</span>
                    @enderror
            ...
            <div class="row mb-3">
                ...
                <div class="col-7">
                    <select class="form-select" name="group" id="example-select">
                        ...
                        <div class="col-6">
                            ...
                            <div>
                                ...
                                <div class="form-check mb-2 form-check-success">
                                    <input class="form-check-input rounded-circle" type="checkbox" value="{{ $item->id }}" name="permission_ids[]" id="{{ $item->id }}">
